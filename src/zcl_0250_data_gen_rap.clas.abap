CLASS zcl_0250_data_gen_rap DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_0250_data_gen_rap IMPLEMENTATION.
  ...
  " NEW CHANGE on my Code
    ...
    delete from ztravel_0250_a.

    insert ztravel_0250_a from (
    ...
    delete from zbooking_0250_a.

    insert zbooking_0250_a from (

        select
          from /dmo/booking
          join ztravel_0250_a on /dmo/booking~travel_id = ztravel_0250_a~travel_id
          join /dmo/travel on /dmo/travel~travel_id = /dmo/booking~travel_id
          fields  "client,
                  uuid( ) as booking_uuid,
                  ztravel_0250_a~travel_uuid as parent_uuid,
                  ...
                  ztravel_0250_a~last_changed_at as local_last_changed_at  ).


    delete from zbksuppl_0250_a.

    out->write( 'Adding Booking Supplements data' ).

    insert zbksuppl_0250_a from (
       select from /dmo/book_suppl as supp
              join ztravel_0250_a  as trvl on trvl~travel_id = supp~travel_id
              join zbooking_0250_a as book on book~parent_uuid = trvl~travel_uuid
